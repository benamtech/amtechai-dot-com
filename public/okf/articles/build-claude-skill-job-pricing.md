...
resource: "https://amtechai.com/articles/build-claude-skill-job-pricing"
tags:
  - "UC4"
  - "UC6"
  - "Quoting and margin"
...
> Use Claude to turn messy job details into a repeatable pricing review: missing facts, cost buckets, margin math, risk flags, and an owner decision memo.
...
- [Find the margin leaks: reviewing every transaction your business makes with AI](/playbooks/find-the-margin-leaks-reviewing-every-transaction-your-business-makes-with-ai.md) — General operational authority.
- [Contractor accounts and material takeoffs: how a Sherman building-supply yard quotes and reorders with AI](/playbooks/contractor-accounts-and-material-takeoffs-how-a-sherman-building-supply-yard-quotes-and-reorders-with-ai.md) — How-to workflow by business type.
- [Find the margin leaks in a Sherman flooring contractor's jobs: AI review of every job's materials and labor](/playbooks/find-the-margin-leaks-in-a-sherman-flooring-contractor-s-jobs-ai-review-of-every-job-s-materials-and-labor.md) — How-to workflow by business type.
- [Quoting and material takeoff for a building-supply yard or trade contractor, run by one AI agent](/playbooks/quoting-and-material-takeoff-for-a-building-supply-yard-or-trade-contractor-run-by-one-ai-agent.md) — Reusable subtype playbook.
