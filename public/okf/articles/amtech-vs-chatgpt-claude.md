...
resource: "https://amtechai.com/articles/amtech-vs-chatgpt-claude"
tags:
  - "UC10"
  - "AI employee"
  - "custom AI agents"
...
- [The connected shop floor: wiring a Phoenix HVAC company's POS, parts supplier, and scheduling into one agent](/playbooks/the-connected-shop-floor-wiring-a-phoenix-hvac-company-s-pos-parts-supplier-and-scheduling-into-one-agent.md) — Deep AMTECH technical proof.
- [An AI operations employee for a Phoenix pool supply-and-service company: inventory, routes, reorder](/playbooks/an-ai-operations-employee-for-a-phoenix-pool-supply-and-service-company-inventory-routes-reorder.md) — Full operations back office by subtype.
