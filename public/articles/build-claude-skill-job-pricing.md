# Build a Claude Skill That Helps You Price Jobs Like a Pro

> A plain-English guide for Claude users who want to create a reusable job profitability skill for pricing local service work.

## Knowledge map

- **Type:** Article
- **Canonical page:** https://amtechai.com/articles/build-claude-skill-job-pricing
- **Format:** Agent-optimized Markdown twin of the HTML article (clean, no page chrome).
- **Topics:** UC4, UC6, Quoting and margin, Claude Skills, job profitability check, local service businesses, AI employees, AI agents, job pricing, gross margin, owner bottleneck, strategy
- **See also:**
  - [Find the margin leaks: reviewing every transaction your business makes with AI](https://amtechai.com/okf/playbooks/find-the-margin-leaks-reviewing-every-transaction-your-business-makes-with-ai.md) — General operational authority
  - [Contractor accounts and material takeoffs: how a Sherman building-supply yard quotes and reorders with AI](https://amtechai.com/okf/playbooks/contractor-accounts-and-material-takeoffs-how-a-sherman-building-supply-yard-quotes-and-reorders-with-ai.md) — How-to workflow by business type
  - [Find the margin leaks in a Sherman flooring contractor's jobs: AI review of every job's materials and labor](https://amtechai.com/okf/playbooks/find-the-margin-leaks-in-a-sherman-flooring-contractor-s-jobs-ai-review-of-every-job-s-materials-and-labor.md) — How-to workflow by business type
  - [Quoting and material takeoff for a building-supply yard or trade contractor, run by one AI agent](https://amtechai.com/okf/playbooks/quoting-and-material-takeoff-for-a-building-supply-yard-or-trade-contractor-run-by-one-ai-agent.md) — Reusable subtype playbook
...
### Try the Job Profitability Check first

Paste this into Claude before you build the full skill. A useful skill starts as a useful repeatable prompt.

```text
I want to run a Job Profitability Check for my local service business.
...
A Claude Skill is a saved set of instructions Claude can reuse for a specific task. For a local service business, a strong first skill is a Job Profitability Check: Claude reviews job details, asks for missing information, estimates costs, calculates price ranges, flags risk, and gives the owner a decision memo before a quote goes out.

## Start with one pricing decision your business repeats every week.
...
## Prompt vs skill vs AI employee

| Term | Plain meaning | Pricing example |
| --- | --- | --- |
...
## How to get started with Claude if you are new.
...
## Pricing is a useful first skill because it is repeated, valuable, and easy to rush.
...
## The 4-step Job Profitability Check

| Step | What Claude should do | Owner value |
| --- | --- | --- |
...
## Step 3: Calculate three prices, not one.
...
## Step 4: Make the owner decision.
...
Use this after the quick-start prompt works. It asks Claude to turn the workflow into a reusable skill file.

```text
I want to create a reusable Claude Skill for my local service business.
...
### Example SKILL.md for the workflow

If your Claude setup supports file-based skills, this is a practical starting point. Customize it with your real labor rates, service types, minimum charges, and approval rules.
...
## Example: a pressure washing owner checks a $650 quote.
...
> **⚠️ Do not build a skill that only says “tell me what to charge.”**
>
> Claude does not automatically know your crew speed, labor burden, material costs, equipment cost, callback rate, market position, minimum job size, warranty policy, schedule pressure, or risk tolerance. The skill should make guessing harder by forcing Claude to ask better questions and show assumptions.

> **⚠️ Do not let AI invent your liabilities.**
>
> Never send an AI-generated quote without reviewing scope, exclusions, assumptions, taxes, payment terms, warranty language, customer promises, safety constraints, licensing, and compliance requirements. A skill can help you think. It should not become an unchecked authority.

## How this connects to AI employees.
...
## Start with one decision your business repeats every week.
...
### Can Claude Skills replace estimating software?

Usually no. A skill can help you reason through pricing and prepare better estimate logic, but it does not automatically replace your CRM, estimating software, accounting system, or field-service platform.

### Do I need to know how to code to build a Claude Skill?

Not for the basic idea. A useful first skill can be written as instructions: what the skill does, when Claude should use it, what steps Claude should follow, and what output Claude should produce.

### Is it safe to use Claude with customer data?

Use judgment. Do not paste sensitive customer, payment, health, identity, or confidential business information into any AI tool unless your policies, plan, and data controls support it.

### What is the best first skill for a local service business?

A job profitability or estimate review skill is a strong first choice because it is practical, repeated often, tied to profit, and easy for the owner to review.

### How is a skill different from asking Claude a question?

A question helps once. A skill helps repeatedly by giving Claude the same checklist, math rules, warnings, and output format every time the workflow appears.

## Citations

[1] [Agent Skills overview](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview) — Claude API Docs
[2] [Anthropic skills repository](https://github.com/anthropics/skills) — Anthropic GitHub
...
[4] [Extend Claude with skills](https://code.claude.com/docs/en/skills) — Claude Code Docs
[5] [How to price your product](https://www.uschamber.com/co/start/strategy/how-to-price-your-product) — U.S. Chamber of Commerce
[6] [Run the Job Costing tool](https://help.servicetitan.com/docs/run-the-job-costing-tool) — ServiceTitan Help

---

Alternate views: [HTML](https://amtechai.com/articles/build-claude-skill-job-pricing) · [OKF concept](https://amtechai.com/okf/articles/build-claude-skill-job-pricing.md) · [llms.txt](https://amtechai.com/llms.txt)
