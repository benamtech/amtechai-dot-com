...
const article: ArticleDefinition = {
  ...
  entities: [
    ...
    { name: 'ChatGPT', type: 'tool', sameAs: ['https://openai.com/chatgpt'] },
    { name: 'Claude', type: 'tool', sameAs: ['https://claude.ai'] },
    { name: 'business brain', type: 'method' },
  ...
  citations: [
    ...
    {
      label: 'Use connectors to extend Claude capabilities',
      url: 'https://support.anthropic.com/en/articles/11176164-pre-built-web-connectors-using-remote-mcp',
  ...
  faqs: [
    {
      question: 'Is AMTECH. better than ChatGPT or Claude?',
      answer: 'Not in the general sense. ChatGPT and Claude are excellent general AI tools. AMTECH. solves a different problem: turning AI into a private business employee that knows your operation, works through your approved tools, and produces business outcomes instead of isolated chat answers.',
    },
    {
      question: 'Can I build something useful with ChatGPT or Claude myself?',
      answer: 'Yes. A motivated owner can use general AI tools for drafting, research, analysis, SOPs, customer messages, and workflow planning. The gap appears when the work must be repeated, connected to records, approved safely, logged, and carried across the business without the owner re-explaining everything every time.',
    },
    {
      question: 'What does AMTECH. mean by AI employee?',
      answer: 'An AI employee is a custom agentic system built around the business. The owner can reach it through familiar channels like SMS, voice, and the AMTECH portal, while the system uses business context, records, tools, skills, and approval rules behind the scenes.',
    },
    {
      question: 'Does the owner still stay in control?',
      answer: 'Yes. A well-built AI employee should be permissive about internal preparation and careful about consequential actions. It can draft, research, organize, and prepare work, then pause for approval before customer-facing commitments, money movement, destructive changes, or unusual decisions.',
    },
  ],
  blocks: [
    {
      type: 'answer',
      body: 'ChatGPT and Claude are general AI tools you operate. AMTECH. builds a custom AI employee that operates inside your business: it knows your context, uses your approved tools, maintains records, produces estimates, reports, follow-ups, and other work product, and asks for approval when a decision matters.',
    },
    {
      type: 'section',
      id: 'short-version',
      eyebrow: 'The short version',
      title: 'The difference is not intelligence. It is business ownership of the workflow.',
      body: [
    ...
    },
    {
      type: 'table',
      id: 'comparison-table',
      title: 'AMTECH. vs. general AI chat tools',
      columns: ['Question', 'ChatGPT or Claude', 'AMTECH. AI employee'],
      rows: [
    ...
    },
    {
      type: 'section',
      id: 'tools-are-useful',
      eyebrow: 'Respect the tools',
      title: 'ChatGPT and Claude are useful. They are just not your business system by default.',
      body: [
    ...
    {
      type: 'section',
      id: 'amtech-builds-employee',
      eyebrow: 'The AMTECH. model',
      title: 'AMTECH. builds the employee, not just the prompt.',
      body: [
    ...
    },
    {
      type: 'callout',
      tone: 'default',
      title: 'The clean mental model',
      body: 'ChatGPT or Claude is a powerful tool you use. AMTECH. is a custom AI employee you manage. One helps you work faster in a chat. The other is designed to take ownership of repeated business work under your rules.',
    },
    {
      type: 'section',
      id: 'office-capacity',
      eyebrow: 'The real problem',
      title: 'Most owners do not have a software problem. They have an office-capacity problem.',
      body: [
    ...
    },
    {
      ...
      columns: ['Situation', 'Use ChatGPT or Claude', 'Use AMTECH.'],
      rows: [
    ...
    },
    {
      ...
      title: 'A contractor estimate shows the difference.',
      body: [
    ...
    {
      type: 'checklist',
      id: 'amtech-fit-checklist',
      title: 'You probably need AMTECH. instead of only DIY AI when:',
      items: [
    ...
    },
    {
      ...
      title: 'Do not confuse access to AI with operational leverage.',
      body: [
    ...
    },
    {
      ...
      id: 'bottom-line',
      eyebrow: 'Bottom line',
      title: 'Use general AI to think. Use AMTECH. when the business needs the work done.',
      body: [
