...
import { INDUSTRIES, TOPICS, formatDateForDisplay } from '../components/schedule/bookingConstants';
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      <header className="border-b border-black/[0.06] bg-white/80 backdrop-blur-xl px-4 sm:px-7 py-3 flex items-center justify-between">
        ...
        <span className="mono-label text-red">Schedule Demo</span>
      </header>
          ...
          {confirmed ? (
            ...
            <>
              <div className="mb-6 sm:mb-8">
                <div className="mb-5">
                  <p className="mono-label text-red mb-1">Book a Demo</p>
                  ...
                  {step === 1 && (
                    ...
                    >
                      <SelectionStep
                        ...
                        subtitle="This helps us tailor the demo to your needs"
                        options={INDUSTRIES}
                        selected={industry}
                  ...
                  {step === 2 && (
                    ...
                    >
                      <SelectionStep
                        ...
                        subtitle="Select the topic you'd like to discuss"
                        options={TOPICS}
                        selected={topic}
                        onSelect={setTopic}
                        onNext={() => setStep(3)}
