...
const auditPrompt = `I want to audit a page for agent-readability using the OKF rubric.
...
export const article: ArticleDefinition = {
  ...
  dek: 'Good writing is not the same as agent-readable infrastructure. Here is what the score reveals and what to fix.',
  ...
  category: 'strategy',
  audience:
    'Founders, content operators, SEO strategists, and technical marketers publishing educational content who want it to reach AI agents and AI search systems',
  ...
  internalLinks: [
    {
      ...
      reason:
        'Explains the Open Knowledge Format this audit is based on — what a concept file looks like, why links become graph edges, and what OKF does not solve on its own.',
    },
    {
      label: 'Build a Local SEO Plan with ChatGPT',
      href: '/articles/build-local-seo-plan-with-chatgpt',
      reason:
        'The entity graph strategy covered here feeds directly into the Entity And Relationship Coverage dimension — mapping services, places, and relationships is the same work.',
    },
    {
      label: 'Build Your Business Brain for Free',
  ...
  citations: [
    {
      label: 'Open Knowledge Format — Google Cloud',
    ...
    {
      label: 'Introduction to structured data — Google Search Central',
      url: 'https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data',
      publisher: 'Google Search Central',
    },
    {
      label: 'Generative Engine Optimization (GEO) — arXiv 2311.09735',
  ...
  faqs: [
    {
      question: 'Does a low OKF audit score mean my content is bad?',
      answer:
    ...
    {
      question: 'Do I need a technical team to fix these gaps?',
      answer:
    ...
    {
      question: 'What is the difference between an OKF audit and regular SEO?',
      answer:
    ...
    {
      question: 'Can I run the OKF audit on a competitor\'s content?',
      answer:
  ...
  blocks: [
    {
      type: 'answer',
      body: 'Most web content scores around 12 out of 30 when an AI agent audits it for agent-readability. That is not a score for bad writing. It is a score for infrastructure. The content may be accurate, well-organized, and genuinely useful to a human reader. The problem is that the same page is nearly invisible to agents fetching it to answer a question, power a recommendation, or use it as trusted context. This article explains the six dimensions of the OKF content audit, shows a live scored example, and names the five infrastructure gaps that explain most low scores.',
    },
    {
      type: 'section',
      id: 'what-is-okf-audit',
      title: 'What the rubric actually measures',
      body: [
    ...
    {
      type: 'table',
      id: 'rubric-dimensions',
      title: 'The six OKF audit dimensions',
      columns: ['Dimension', 'What it scores'],
      rows: [
        [
          'First-Fetch Clarity',
          'Does the first-fetched surface tell an agent what the page is, who it serves, and what to do next — without executing JavaScript or following links?',
        ],
        [
          'Concept Packaging',
          'Is there one stable concept per page? Is machine-readable metadata present: author, date, type, description, tags, and source URL?',
        ],
        [
          'Entity And Relationship Coverage',
          'Are the important people, places, tools, industries, and use cases named consistently and linked to related concepts with relationship reasons?',
        ],
        [
          'Source And Citation Quality',
          'Are claims traceable? Are external sources linked near the claims they support? Are dates concrete and generated or inferred claims labeled?',
        ],
        [
          'Materialized Views',
          'Is the content available in multiple surfaces: human HTML page, markdown or text view, JSON structured data, sitemap, discovery links, and downloadable package when relevant?',
        ],
        [
          'Agent Execution Readiness',
          'If the content is a workflow or guide, can an agent act from it directly? Is the workflow ordered, with explicit inputs, outputs, failure modes, and a copy-paste action prompt?',
        ],
      ],
    },
    {
    ...
    },
    {
      type: 'section',
      id: 'dimension-detail',
      title: 'Why each dimension catches a real gap',
      body: [
    ...
    },
    {
      type: 'table',
      id: 'live-audit',
      title: 'Live audit: amtechai.com/articles/garden-center-spring-buy-plan-ai',
      columns: ['Dimension', 'Score', 'Finding'],
      rows: [
        [
          'First-Fetch Clarity',
          '2 / 5',
          'URL slug says "garden-center" but article covers six business types. No author name or date visible to a non-executing agent.',
        ],
        [
          'Concept Packaging',
          '2 / 5',
          'Author and date exist in the React data layer but are invisible in the static HTML. No YAML frontmatter or JSON-LD author block in first-fetch surface.',
        ],
        [
          'Entity And Relationship Coverage',
          '2 / 5',
          'Six business types listed. Zero AI tools named — "AI" appears throughout with no model, platform, or tool identified.',
        ],
        [
          'Source And Citation Quality',
          '1 / 5',
          'Zero external citations. Competitive-advantage claims stated as fact with no supporting data or sources.',
        ],
        [
          'Materialized Views',
          '2 / 5',
          'React page renders correctly for human readers. Non-executing agents receive a minimal HTML shell. No standalone markdown view or JSON manifest.',
        ],
        [
          'Agent Execution Readiness',
          '3 / 5',
          'Three labeled copy-paste prompts are the article\'s strongest asset. Missing a top-level workflow summary and a remediation prompt.',
        ],
      ],
    },
    {
      ...
      title: 'The five infrastructure concepts behind low scores',
      body: [
    ...
    {
      type: 'table',
      id: 'amtech-projections',
      title: 'One source, many projections: how AMTECH builds agent-readable content',
    ...
    {
      type: 'callout',
      title: 'Good writing is not the same as agent-readable infrastructure',
      body: 'A well-written article can score 12 out of 30. The prose is clear. The advice is sound. A human who finds the page can use it. But an agent fetching the URL to answer a downstream question gets a shell, no author, no date, no named tools, no citations, and no links to follow. The content exists. The infrastructure does not. Both matter now.',
      tone: 'warning',
    },
    {
      type: 'prompt',
    ...
    {
      type: 'checklist',
      id: 'afternoon-checklist',
      title: 'Five checks you can do in one afternoon',
      items: [
