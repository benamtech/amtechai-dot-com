...
const entityGraphPrompt = `You are a local SEO strategist. I run a [business type] in [city / region].
...
const gapAuditPrompt = `Using the entity graph above, find the pages my competitors probably have not written well.
...
const publishingPrompt = `Turn the highest-opportunity SEO gaps into a 90-day publishing plan.
...
export const article: ArticleDefinition = {
  slug: 'build-local-seo-plan-with-chatgpt',
  title: 'How to Use ChatGPT or Claude to Build a Local SEO Plan That Out-Ranks Bigger Competitors',
  description: 'Give ChatGPT or Claude your services, local conditions, and buyer questions. Turn the output into a knowledge graph, publish answer-first pages, and become the source AI search wants to cite.',
  dek: 'A brand-new site can beat lazy high-authority competitors when it becomes the clearest source on the exact problems, places, materials, and decisions customers actually search for.',
  datePublished: '2026-06-18',
  dateModified: '2026-06-18',
  authorName: 'AMTECH staff',
  readingTime: '12 min read',
  category: 'strategy',
  audience: 'local service business owners, contractors, operators, and founders who want AI-assisted SEO that compounds instead of generic blog volume',
  primaryEntity: { name: 'Knowledge graph SEO', type: 'method' },
  entities: [
    { name: 'Local SEO', type: 'method' },
    { name: 'AI Overviews', type: 'tool' },
    { name: 'Query fan-out', type: 'method' },
    { name: 'Information gain', type: 'method' },
    { name: 'ChatGPT', type: 'tool' },
    { name: 'Claude', type: 'tool' },
    { name: 'Local service businesses', type: 'customer' },
    { name: 'Topical authority', type: 'outcome' },
  ],
  internalLinks: [
  ...
  citations: [
    ...
    { label: 'Structured data introduction', url: 'https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data', publisher: 'Google Search Central' },
    { label: 'Local ranking: relevance, distance, and prominence', url: 'https://support.google.com/business/answer/7091', publisher: 'Google Business Profile Help' },
    { label: 'Contextual estimation of link information gain', url: 'https://patents.google.com/patent/US20200349181A1/en', publisher: 'Google Patents' },
    { label: 'A survey on knowledge graphs: representation, acquisition, and applications', url: 'https://arxiv.org/abs/2002.00388', publisher: 'arXiv' },
  ],
  faqs: [
    { question: 'Will ChatGPT or Claude make up local facts?', answer: 'Sometimes. Use the model for structure, questions, outlines, and first drafts. Verify local claims with official sources, field photos, job notes, customer conversations, and real operator experience before publishing.' },
    { question: 'How many pages do I need?', answer: 'Fewer, sharper pages beat a big pile of thin pages. Start with 20 high-information-gain pages that each answer one real local question better than the current results.' },
    { question: 'Do I still need a Google Business Profile and reviews?', answer: 'Yes. The website explains what you know. Your Business Profile, reviews, photos, citations, and local links help prove you exist, serve the area, and deserve trust.' },
    { question: 'Is this just publishing a lot of AI content?', answer: 'No. Volume without original detail is spam with better grammar. This strategy only works when every page adds a useful distinction: a local condition, a decision threshold, a diagnostic table, a verified source, or a field observation competitors missed.' },
  ],
  blocks: [
    { type: 'answer', body: 'Use ChatGPT or Claude to map your business into a local knowledge graph: services, customer problems, materials, local conditions, locations, proof, and buying questions. Then publish one answer-first page for each high-value intersection. Bigger competitors usually have authority. You win by having the most specific, useful, locally true answer on the subquestions AI search now breaks apart.' },
    { type: 'callout', tone: 'success', title: 'This is not theory for us.', body: 'AMTECH used this exact strategy to push a brand-new, roughly two-month-old site with almost no article library into Google AI Overviews. Not with 10,000 posts. Not with a decade-old domain. With a tighter graph, clearer answers, and pages that made the machine’s job easier.' },
    { type: 'section', id: 'why-now', eyebrow: 'The opening', title: 'Search is turning into a research assistant. That is the crack in the wall.', body: [
    ...
    { type: 'table', id: 'pyramid', title: 'The pyramid structure for every page', columns: ['Layer', 'What goes there', 'Why it works'], rows: [
    ...
    { type: 'section', id: 'entity-graph', eyebrow: 'Step 1', title: 'Turn your business into an entity graph.', body: [
    ...
    { type: 'prompt', id: 'entity-graph-prompt', title: 'Prompt 1: build the local entity graph', helper: 'Paste this into ChatGPT or Claude, then replace the bracketed fields.', body: entityGraphPrompt },
    { type: 'table', id: 'phoenix-example', title: 'Example: the graph starts turning into pages', columns: ['Intersection', 'Article question', 'Why a national site struggles'], rows: [
    ...
    { type: 'section', id: 'gap-audit', eyebrow: 'Step 2', title: 'Find the gaps authority sites left open.', body: [
    ...
    { type: 'prompt', id: 'gap-audit-prompt', title: 'Prompt 2: rank the content gaps', helper: 'This prompt forces the model to separate generic filler from local expertise.', body: gapAuditPrompt },
    { type: 'callout', tone: 'warning', title: 'Important: AI is the strategist, not the witness.', body: 'ChatGPT can structure the plan. It cannot truthfully claim your customer’s yard has caliche, your city requires a permit, or your team saw a specific failure mode unless you verify it. The proof layer is what separates authority from AI slop.' },
    { type: 'section', id: 'publishing-plan', eyebrow: 'Step 3', title: 'Turn the graph into a publishing plan.', body: [
    ...
    { type: 'prompt', id: 'publishing-prompt', title: 'Prompt 3: build the 90-day plan', helper: 'Use this after the graph and gap audit. It creates an action-first queue instead of a vague content calendar.', body: publishingPrompt },
    { type: 'checklist', id: 'page-checklist', title: 'The article template that actually deserves to rank', items: [
    ...
    { type: 'section', id: 'research', eyebrow: 'Why the structure has legs', title: 'The research backs the instinct: useful graphs beat isolated posts.', body: [
    ...
    { type: 'section', id: 'execution', eyebrow: 'The real unlock', title: 'Aggressive only works if the standard is strict.', body: [
    ...
    { type: 'section', id: 'amtech', eyebrow: 'How we use it', title: 'This is the system AMTECH is building for operators.', body: [
