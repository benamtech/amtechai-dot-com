...
const concepts: EntityDef[] = [
  ...
  { id: 'concept-sovereign-ai', kind: 'Method', dir: 'entities', slug: 'concept-sovereign-ai', title: 'Sovereign AI', description: 'National control over the AI operating layer — the model, compute, data, physical machines, and permissions — so a country is not dependent on foreign models. The country-scale version of the control problem a business faces.', tags: ['Method', 'sovereign AI'], matchNames: ['sovereign AI'], relatedEntityIds: ['concept-physical-ai', 'concept-business-sovereignty', 'service-ai-employee'] },
  { id: 'concept-physical-ai', kind: 'Method', dir: 'entities', slug: 'concept-physical-ai', title: 'Physical AI', description: 'AI that acts in the physical world — multimodal models built to run robots, vehicles, and equipment from images, video, audio, and sensor data rather than text alone. The layer of the control stack where AI takes real-world action.', tags: ['Method', 'physical AI'], matchNames: ['physical AI'], relatedEntityIds: ['concept-sovereign-ai'] },
  { id: 'concept-business-sovereignty', kind: 'Outcome', dir: 'entities', slug: 'concept-business-sovereignty', title: 'Business sovereignty', description: 'The small-business analog of sovereign AI: instead of owning a model, the owner owns the layer around a rented model — a business brain, connectors on their own accounts, an approval gate, and an audit trail.', tags: ['Outcome', 'business sovereignty'], matchNames: ['business sovereignty'], relatedEntityIds: ['concept-sovereign-ai', 'service-ai-employee', 'service-business-brain', 'concept-approval-gate', 'concept-connector'] },
  { id: 'concept-approval-gate', kind: 'Method', dir: 'entities', slug: 'concept-approval-gate', title: 'Approval gate', description: 'The trust boundary where anything that leaves the business or moves money waits for the owner\'s explicit yes. Enforced structurally by the kind of work, so a money-touching action cannot skip the confirmation.', tags: ['Method', 'approval gate', 'confirmation gate'], matchNames: ['approval gate', 'confirmation gate'], relatedEntityIds: ['service-ai-employee', 'concept-business-sovereignty'] },
  { id: 'concept-connector', kind: 'Tool', dir: 'entities', slug: 'concept-connector', title: 'Connector', description: 'A live integration — Gmail, Stripe, calendar, files — wired on the owner\'s own accounts so the AI Employee has operating context and action rights the owner controls, added one at a time as trust grows.', tags: ['Tool', 'connector', 'connectors'], matchNames: ['connector', 'connectors'], relatedEntityIds: ['service-ai-employee', 'concept-approval-gate', 'concept-business-sovereignty'] },
];
