...
export const articleKnowledgeGraphNodes: KnowledgeGraphNode[] = [
  ...
  { id: 'E9', title: "What Is OKF? Google's New Format For AI-Readable Knowledge", slug: 'what-is-okf-ai-readable-knowledge', href: '/articles/what-is-okf-ai-readable-knowledge', type: 'EXISTING', typeLabel: 'Published OKF and agentic-search explainer', status: 'published', uc: 'Local authority / Agentic SEO', mechanism: 'Explains OKF as a portable markdown concept bundle, then shows why AMTECH treats it as one surface generated from a richer entity graph.', audience: 'Founders, technical marketers, SEO strategists, content operators, and AI builders', topic: 'Open Knowledge Format', description: 'A plain-English explanation of OKF, knowledge graphs, and the AMTECH standard for turning useful content into agent-readable surfaces.', connectsTo: ['E1', 'E2', 'E4', 'E10', 'N1'] },
  { id: 'E10', title: 'What AI Agents See When They Read Your Website', slug: 'what-ai-agents-see-when-they-read-your-website', href: '/articles/what-ai-agents-see-when-they-read-your-website', type: 'EXISTING', typeLabel: 'Published OKF audit walkthrough and content infrastructure explainer', status: 'published', uc: 'Agentic SEO / Content infrastructure', mechanism: 'Runs a live OKF audit on a real article, scores it 12/30 across six rubric dimensions, and names the five infrastructure gaps that keep most content invisible to AI agents.', audience: 'Founders, content operators, SEO strategists, and technical marketers publishing educational content', topic: 'OKF content audit', description: 'A scored walkthrough showing exactly what agents see when they fetch a page, dimension by dimension, with the five infrastructure fixes that move content from invisible to usable.', connectsTo: ['E9', 'E2', 'E1', 'E4'] },
...
export const articleTopicGroups = [
  ...
  { title: 'Knowledge graph and agentic search', description: 'Entity SEO, OKF, Business Brain context, and agent-readable publishing surfaces.', nodeIds: ['E10', 'E9', 'E2', 'E1', 'E4', 'N1'] },
