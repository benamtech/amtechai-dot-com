...
export const articleKnowledgeGraphNodes: KnowledgeGraphNode[] = [
  ...
  planned(18, 'Spring ordering for a Salisbury garden center: forecasting what to buy from three seasons of sales data', 'T5', 'UC3', 'Seasonal sales history creates a perishable buy plan.', 'Salisbury', 'garden center'),
...
export const articleTopicGroups = [
  ...
  { title: 'Purchasing, inventory, and forecasting', description: 'Reorder lists, stock-ahead planning, perishable inventory, route loadouts, and demand swings.', nodeIds: ['N2', 'N24', 'N35', 'N36', 'N37', 'N18', 'N28', 'N30'] },
  ...
  { title: 'Salisbury and Chesapeake operators', description: 'Independent pharmacy, garden center, bike shop, marine service, and second-location readiness.', nodeIds: ['N5', 'N8', 'N18', 'N19', 'N20', 'N27', 'N30', 'N34', 'N39'] },
];
