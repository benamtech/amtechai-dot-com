              ...
              <button
                ...
                className={`flex h-10 w-10 items-center justify-center border transition-all ${
                  isMuted
                    ...
                    : 'border-black/[0.06] bg-white text-black/50 hover:text-black'
                }`}
              >
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-6">
          <div className="relative flex items-center justify-center" style={{ width: '320px', height: '320px' }}>
            ...
            <div className="relative z-10 flex flex-col items-center">
              {status === 'disconnected' ? (
                <button
                  onClick={startCall}
                  className="group flex h-24 w-24 items-center justify-center border border-red/30 bg-white transition-all hover:border-red hover:shadow-red-glow"
                >
                ...
                <div className="flex h-24 w-24 items-center justify-center">
                  <div
                    className={`h-3 w-3 ${
                      status === 'speaking' ? 'bg-red' : 'bg-black'
          ...
          <div className="mt-8 text-center">
            <p className={`font-mono text-xs uppercase tracking-[0.2em] ${
              status === 'speaking' ? 'text-red' : 'text-black/40'
            }`}>
              {getStatusLabel()}
            </p>
          ...
          {messages.length > 0 && (
            <button
              ...
              className="mt-6 font-mono text-[0.6rem] uppercase tracking-[0.15em] text-black/40 transition-colors hover:text-black"
            >
