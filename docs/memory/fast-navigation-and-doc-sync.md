...
4. Inspect only the route page, feature folder, migration, service file, or Edge Function identified by those references.
5. Use targeted `rg` searches only after the codegraph/reference docs do not answer the question.
...
- Durable design, product, market, or internal research findings.
