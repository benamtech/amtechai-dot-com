...
| `/articles/write-pressure-washing-estimate-with-ai`, `/articles/estimate-painting-cost-ai`, `/articles/create-estimate-with-chatgpt` | `src/pages/AIEstimateArticles.tsx` | `src/components/articles/*`, `src/lib/articles.ts`, layout | Knowledge graph articles for AI-assisted contractor estimating prompts and workflows. |
