...
Most recent handoff: `docs/memory/status-2026-06-19--skill-ca-m0-catalog-bootstrap.md` (skill certificate-authority standard — **M0 catalog/hub bootstrap shipped**: the `/skills` hub is now self-bootstrapping via `src/lib/skills/renderHubContent.ts` + `public/skills/catalog.json`; next is M1 v2 attestations. Build plan in `docs/skills/standard/08-build-plan.md`).
